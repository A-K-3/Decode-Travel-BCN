...
proto3.util.setEnumType(ProductCodeType, "cmp.types.v4.ProductCodeType", [
 ...
 * 
 * ![Diagram](https://storage.googleapis.com/docs-cmp-files/diagrams/proto/cmp/types/v4/product_code.proto.dot.xs.svg)
 * 
 * [Open Message Diagram](https://storage.googleapis.com/docs-cmp-files/diagrams/proto/cmp/types/v4/product_code.proto.dot.svg)
 *
...
export class ProductCode extends Message<ProductCode> {
  ...
  static readonly typeName = "cmp.types.v4.ProductCode";
...
export class SupplierProductCode extends Message<SupplierProductCode> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cmp.types.v4.SupplierProductCode";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "code", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "number", kind: "scalar", T: 13 /* ScalarType.UINT32 */ },
  ]);
