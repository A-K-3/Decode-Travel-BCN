...
import { Length } from "../v1/measurement_pb";
...
proto3.util.setEnumType(LocationCodeType, "cmp.types.v2.LocationCodeType", [
...
export class Coordinates extends Message<Coordinates> {
  ...
  static readonly typeName = "cmp.types.v2.Coordinates";
...
export class GeoCircle extends Message<GeoCircle> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cmp.types.v2.GeoCircle";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
export class GeoPolygon extends Message<GeoPolygon> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cmp.types.v2.GeoPolygon";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
export class GeoTree extends Message<GeoTree> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cmp.types.v2.GeoTree";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
export class LocationCode extends Message<LocationCode> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cmp.types.v2.LocationCode";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
export class LocationCodes extends Message<LocationCodes> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cmp.types.v2.LocationCodes";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
