...
/**
 * Describes the file cmp/types/v2/price.proto.
 */
export const file_cmp_types_v2_price: GenFile = /*@__PURE__*/
  fileDesc("", [file_cmp_types_v1_price_type, file_cmp_types_v2_currency]);
 ...
 *
 * ![Diagram](https://storage.googleapis.com/docs-cmp-files/diagrams/c4t/proto/cmp/types/v2/price.proto.dot.xs.svg)
 *
 * [Open Message Diagram](https://storage.googleapis.com/docs-cmp-files/diagrams/c4t/proto/cmp/types/v2/price.proto.dot.svg)
 *
 * @generated from message cmp.types.v2.PriceDetail
 */
export type PriceDetail = Message<"cmp.types.v2.PriceDetail"> & {
  /**
 ...
 */
export type Price = Message<"cmp.types.v2.Price"> & {
  /**
