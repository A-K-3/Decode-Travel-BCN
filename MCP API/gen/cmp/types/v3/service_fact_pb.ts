...
// @generated from file cmp/types/v3/service_fact.proto (package cmp.types.v3, syntax proto3)
/* eslint-disable */
 ...
 *
 *
 * ![Diagram](https://storage.googleapis.com/docs-cmp-files/diagrams/c4t/proto/cmp/types/v3/service_fact.proto.dot.xs.svg)
 *
 * [Open Message Diagram](https://storage.googleapis.com/docs-cmp-files/diagrams/c4t/proto/cmp/types/v3/service_fact.proto.dot.svg)
 *
 * @generated from message cmp.types.v3.ServiceFact
 */
export type ServiceFact = Message<"cmp.types.v3.ServiceFact"> & {
  /**
   ...
   *
   * @generated from field: cmp.types.v3.PriceDetail price_detail = 3;
   */
   ...
   *
   * @generated from field: cmp.types.v3.ServiceAvailabilityType availability_type = 4;
   */
   ...
   *
   * @generated from field: cmp.types.v3.ChargeBasisType charge_basis = 5;
   */
   ...
   *
   * @generated from field: repeated cmp.types.v3.ServiceFact details = 6;
   */
  details: ServiceFact[];
...
/**
 * Describes the message cmp.types.v3.ServiceFact.
 * Use `create(ServiceFactSchema)` to create a new message.
 */
export const ServiceFactSchema: GenMessage<ServiceFact> = /*@__PURE__*/
  messageDesc(file_cmp_types_v3_service_fact, 0);

/**
 * @generated from enum cmp.types.v3.ServiceAvailabilityType
 */
...
/**
 * Describes the enum cmp.types.v3.ServiceAvailabilityType.
 */
export const ServiceAvailabilityTypeSchema: GenEnum<ServiceAvailabilityType> = /*@__PURE__*/
  enumDesc(file_cmp_types_v3_service_fact, 0);

/**
 * @generated from enum cmp.types.v3.ChargeBasisType
 */
...
/**
 * Describes the enum cmp.types.v3.ChargeBasisType.
 */
export const ChargeBasisTypeSchema: GenEnum<ChargeBasisType> = /*@__PURE__*/
  enumDesc(file_cmp_types_v3_service_fact, 1);
