...
import { file_cmp_services_accommodation_v2_search_query_types } from "./search_query_types_pb.js";
import type { AccommodationSearchResult } from "./search_result_types_pb.js";
import { file_cmp_services_accommodation_v2_search_result_types } from "./search_result_types_pb.js";
...
/**
 * Describes the file cmp/services/accommodation/v2/search.proto.
 */
export const file_cmp_services_accommodation_v2_search: GenFile = /*@__PURE__*/
  fileDesc("", [file_cmp_services_accommodation_v2_search_query_types, file_cmp_services_accommodation_v2_search_result_types, file_cmp_types_v1_common, file_cmp_types_v2_search, file_cmp_types_v2_traveller]);
 ...
 *
 *
 * @generated from message cmp.services.accommodation.v2.AccommodationSearchRequest
 */
export type AccommodationSearchRequest = Message<"cmp.services.accommodation.v2.AccommodationSearchRequest"> & {
  /**
   ...
   *
   * @generated from field: repeated cmp.services.accommodation.v2.AccommodationSearchQuery queries = 4;
   */
  queries: AccommodationSearchQuery[];
};

/**
 * Describes the message cmp.services.accommodation.v2.AccommodationSearchRequest.
...
export const AccommodationSearchRequestSchema: GenMessage<AccommodationSearchRequest> = /*@__PURE__*/
  messageDesc(file_cmp_services_accommodation_v2_search, 0);
 ...
 *
 * @generated from message cmp.services.accommodation.v2.AccommodationSearchResponse
 */
export type AccommodationSearchResponse = Message<"cmp.services.accommodation.v2.AccommodationSearchResponse"> & {
  /**
   * Message header. Contains API version, message info string and end user wallet
   * address.
   *
   ...
   *
   * @generated from field: repeated cmp.services.accommodation.v2.AccommodationSearchResult results = 3;
   */
...
/**
 * Describes the message cmp.services.accommodation.v2.AccommodationSearchResponse.
...
export const AccommodationSearchResponseSchema: GenMessage<AccommodationSearchResponse> = /*@__PURE__*/
  messageDesc(file_cmp_services_accommodation_v2_search, 1);
...
export const AccommodationSearchService: GenService<{
  ...
  serviceDesc(file_cmp_services_accommodation_v2_search, 0);
