...
// @generated from file cmp/services/activity/v2/search.proto (package cmp.services.activity.v2, syntax proto3)
/* eslint-disable */
...
import { file_cmp_services_activity_v2_search_parameters_types } from "./search_parameters_types_pb.js";
import type { ActivitySearchResult } from "./search_result_types_pb.js";
import { file_cmp_services_activity_v2_search_result_types } from "./search_result_types_pb.js";
...
/**
 * Describes the file cmp/services/activity/v2/search.proto.
 */
export const file_cmp_services_activity_v2_search: GenFile = /*@__PURE__*/
  fileDesc("", [file_cmp_services_activity_v2_search_parameters_types, file_cmp_services_activity_v2_search_result_types, file_cmp_types_v1_common, file_cmp_types_v1_travel_period, file_cmp_types_v2_location, file_cmp_types_v2_search, file_cmp_types_v2_traveller]);

/**
 * Search request for Activities
 *
 * @generated from message cmp.services.activity.v2.ActivitySearchRequest
 */
export type ActivitySearchRequest = Message<"cmp.services.activity.v2.ActivitySearchRequest"> & {
  /**
   ...
   *
   * @generated from field: cmp.services.activity.v2.ActivitySearchParameters search_parameters_activity = 4;
   */
   ...
   * Travellers
   *
   * @generated from field: repeated cmp.types.v2.BasicTraveller travellers = 6;
   */
   ...
   *
   * @generated from oneof cmp.services.activity.v2.ActivitySearchRequest.source_location
   */
  sourceLocation: {
    /**
   ...
   * setting one will remove the others.
   *
   * @generated from oneof cmp.services.activity.v2.ActivitySearchRequest.service_location
   */
  serviceLocation: {
    /**
...
/**
 * Describes the message cmp.services.activity.v2.ActivitySearchRequest.
...
export const ActivitySearchRequestSchema: GenMessage<ActivitySearchRequest> = /*@__PURE__*/
  messageDesc(file_cmp_services_activity_v2_search, 0);

/**
 * @generated from message cmp.services.activity.v2.ActivitySearchResponse
 */
export type ActivitySearchResponse = Message<"cmp.services.activity.v2.ActivitySearchResponse"> & {
  /**
   * Message header. Contains API version, message info string and end user wallet
   * address.
   *
   ...
   *
   * @generated from field: repeated cmp.services.activity.v2.ActivitySearchResult results = 3;
   */
...
/**
 * Describes the message cmp.services.activity.v2.ActivitySearchResponse.
...
export const ActivitySearchResponseSchema: GenMessage<ActivitySearchResponse> = /*@__PURE__*/
  messageDesc(file_cmp_services_activity_v2_search, 1);
 ...
 *
 * ![Diagram](https://storage.googleapis.com/docs-cmp-files/diagrams/c4t/proto/cmp/services/activity/v2/search.proto.dot.xs.svg)
 *
 * [Open Message Diagram](https://storage.googleapis.com/docs-cmp-files/diagrams/c4t/proto/cmp/services/activity/v2/search.proto.dot.svg)
 *
 * / @custom:cmp-service type:product routing:p2p on-chain:false
 *
 * @generated from service cmp.services.activity.v2.ActivitySearchService
 */
export const ActivitySearchService: GenService<{
  /**
   * @generated from rpc cmp.services.activity.v2.ActivitySearchService.ActivitySearch
   */
  activitySearch: {
    methodKind: "unary";
  ...
  serviceDesc(file_cmp_services_activity_v2_search, 0);
